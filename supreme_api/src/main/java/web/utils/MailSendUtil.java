...
public class MailSendUtil {
    ...
    private final static String formName = "17610600566@163.com";//你的邮箱
    private final static String password = "LINMAOSHENG123"; //授权码
    private final static String replayAddress = "17610600566@163.com"; //你的邮箱
    ...
    private static Message getMessage(MailInfo info) throws Exception{
        ...
        //消息的发送者
        message.setFrom(new InternetAddress(p.getProperty("mail.smtp.user"),"mark ADMIN"));
